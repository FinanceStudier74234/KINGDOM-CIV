...
export const RULER_BACKGROUNDS: RulerBackgroundDef[] = [
  ...
  },
  {
    ...
    bonusResources: { gold: 40, happiness: -5, stability: -3 },
    specialAbility: 'Trade Networks',
    abilityDescription: 'Gold income +18%, but nobles resent merchant rule.',
  },
  {
    id: 'holy_crusader',
    name: 'Holy Crusader',
  ...
  },
  {
    ...
    startingTrait: 'just',
    bonusResources: { happiness: 12, population: 10, gold: -15, stability: -5 },
